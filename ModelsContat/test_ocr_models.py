...
def test_rec_mv3_none_bilstm_ctc():
    ...
    """
    model = TestOcrModel(model='rec_mv3_none_bilstm_ctc',
...
def test_det_mv3_db():
    ...
    """
    model = TestOcrModel(model='det_mv3_db',
                         yaml='configs/det/det_mv3_db.yml')
    model.test_ocr_train()
    model.test_ocr_eval()
...
def test_e2e_r50_vd_pg():
    ...
    """
    model = TestOcrModel(model='e2e_r50_vd_pg',
                         yaml='configs/e2e/e2e_r50_vd_pg.yml')
    model.test_ocr_eval()
...
def test_cls_mv3():
    ...
    cls_mv3 test case
    """
    model = TestOcrModel(model='cls_mv3',
                         yaml='configs/cls/cls_mv3.yml')
    model.test_ocr_train()
    model.test_ocr_eval()
