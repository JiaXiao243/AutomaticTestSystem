...
def test_bert_finetune():
    ...
    cmd='''cd PaddleNLP/model_zoo/bert;
           ...
           python -m paddle.distributed.launch --gpus "0,1,2,3" --log_dir log_SST-2_gpu4 ./run_glue.py  --model_type bert --model_name_or_path bert-base-cased --task_name SST2 --max_seq_length 128 --batch_size 32 --learning_rate 1e-4 --num_train_epochs 1 --logging_steps 10 --save_steps 500 --output_dir ./output_SST-2_gpu4/ --device gpu
        '''
    model.test_nlp_train(cmd=cmd)
...
def test_electra():
    ...
    cmd='''cd PaddleNLP/model_zoo/electra/;
           export CUDA_VISIBLE_DEVICES=0,1,2,3
           python -u ./run_glue.py  --model_type electra --model_name_or_path electra-small --task_name SST-2 --max_seq_length 128 --batch_size 32 --learning_rate 1e-4 --num_train_epochs 1 --logging_steps 10 --save_steps 500 --output_dir ./output_SST-2_gpu4/ --device gpu
        '''
    model.test_nlp_train(cmd=cmd)
