...
class RepoInit():
      def __init__(self, repo):
         ...
         cmd='''git clone https://github.com/PaddlePaddle/%s.git --depth 1; ''' % (self.repo)
         print(cmd)
         repo_result=subprocess.getstatusoutput(cmd)
         exit_code=repo_result[0]
...
class TestClassModel():
      ...
      def test_class_train(self):
          ...
          if self.model=='PPLCNetV2_base':
             cmd=cmd.replace('DataLoader.Train.sampler.batch_size','DataLoader.Train.sampler.first_bs')           
          print(cmd) 
