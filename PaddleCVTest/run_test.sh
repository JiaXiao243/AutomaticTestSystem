...
export REPORT_SERVER_USERNAME=paddle 
export REPORT_SERVER_PASSWORD=915eedab953b6f51151f50eb 
curl -s ${REPORT_SERVER}/report/upload.sh | bash -s report_test 22 result
